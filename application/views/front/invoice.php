...
<div id="invoiceholder">
	<div id="invoice" class="effect2">
		...
		<div id="invoice-top">
            ...
            <div class="clearfix">
            <div class="col-left">
                <div class="logo"><img src="<?php echo base_url();?>assets/images/logo/header.png" alt="OTG CARES" /></div>
                <div class="clientinfo">
                    <h2 id="supplier">OTGcares</h2>
                    <p><span id="address">S-53, Haware Fantasia Business park, <br> Vashi Navi Mumbai Thane Maharashtra 400708</span><br>
            ...
            <h2 id="supplier">INVOICE</h2>
                <table class="table">
                    <tbody>
                        <tr>
                            <td><span>Invoice Number</span><label id="invoice_no" class='float-right'>INV-<?= $invoice_create[0]['request_id_value'] ?></label></td>
                        </tr>
                        <tr>
                            <td><span>Order Number</span><label id="order-number"  class='float-right'><?= $invoice_create[0]['request_id_value'] ?></label></td>
                        </tr>
                        <tr>
		...
		<div id="invoice-mid">
			<div id="message">
				<h2>Bill To,</h2>
				<p><?= $invoice_create[0]['name'] ?> <span id="supplier_name"></span><br>+91 <?= $invoice_create[0]['contact'] ?></p>
			</div>
		...
		<div id="invoice-bot">
			...
			<div id="table">
				<table class="table-main ">
					...
					<tr class="list-item">
						...
						<td data-label="Taxable Amount" class="tableitem" id="cBalance"><?= $invoice_create[0]['total_amount'] ?></td>
					...
					<tr class="list-item">
						<td colspan="6" style="border-left:2px solid #dee2e6;text-transform:capitalize" class='words text-left'></td>
                        <td data-label="Grand Total" class="tableitem">Subtotal</td>
						<td data-label="Grand Total" class="tableitem numberword" id='result'><?= $invoice_create[0]['total_amount'] ?></td>
					</tr>
                    <tr class="list-item">
						...
						<td data-label="Grand Total" class="tableitem" id='result'><?= $invoice_create[0]['total_amount'] ?></td>
					</tr>
                    <tr class="list-item">
            ...
            <div id="table">
				<table class="table table-bordered ">
						<tr class="">
							<th>Notes <p>Thank You For Doing Business With Us</p></th>
							<th >Bank Details</th>
					...
					<tr class="">
						<td colspan='2'><h2>Terms And Conditions</h2>
                            <p> A.M.C Upto 1.5 Ton - 3 Jet Service + 1 Time Gas Recharge + Unlimited Repair Total 3 Basic AMC And 2 Service AMC Is Included In Your Contract.</p>
</td>
						<td  class="">
                            heelo
                            <p> For OTGCares</p>
