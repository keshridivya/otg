                	...
                	<div class="row justify-content-space-evenly">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-2  contact-box">
                            ...
                            <ul class="addressFooter">
                            	<li><i class="fa-solid fa-location-dot"></i><p>55 Gallaxy Enque,<br>2568 steet, 23568 NY</p></li>
                                <li class="email"><i class="fa-solid fa-envelope"></i><p>sales@yousite.com</p></li>
                                <li class="phone"><i class="fa-solid fa-phone"></i><p>(440) 000 000 0000</p></li>
                            </ul>
                        </div>
                    </div>
                    <div class="row justify-content-space-evenly">
