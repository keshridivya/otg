                                                 ...
                                                 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="form-checkboxes">
                                                            ...
                                                            <div class="col-lg-12">
                                                                    <div class="form-group form-check">
                                                                        <input type="checkbox" class="form-check-input" name="year_warrenty" id="year_warrenty">
                                                                        <label class="form-check-label" for="year_warrenty">Device Manufacture Warranty Should be 1 Year or Months</label>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <button type="submit" name="submit" class="btn" value="register">Continue</button>
                                                    </form>
