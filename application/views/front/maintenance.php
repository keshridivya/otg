...
<div class="cont1 contsec" id="modal-opened">
	<div class="modal modaldisplay modalalready">
		...
		<p class="para">Your cart contains Repair and Services plan. Would you like to discard it and replace it with Protection
			plans?</p>
			<!-- <div class="plan-btns">
		...
		<button class="addcart1" id="closesec">No </button>
		<input type="hidden" id="planid">
		<input type="hidden" id="strplan">
												...
												<div class="type-plan-details">
													<div class="plan-table">
														...
														<div class='float_right_justify'>
															...
															<div class="plan-btns">
																<a data-id="<?= $plandata['cplan_id']; ?>" data-name="<?php echo $plandata['cplan_name'];?>" data-plan="<?= $plandata['subcat_name']; ?>"
																	class="addcart">Add</a>
															</div>
...
<script>
	$('.addcart').click(function () {
		...
		let strplan = planname.substr(-3);
		// alert(planname.substr(-3));
