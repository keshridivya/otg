                	...
                	<div class="container-fluid">
                		<div class="row">
                			<div class="col-lg-12">
                				...
                				<!--	<button class="nav-link nav_btn active" id="v-pills-profile-tab" data-toggle="pill"-->
                				<!--		data-target="#v-pills-profile" type="button" role="tab"-->
                				<!--		aria-controls="v-pills-profile" aria-selected="false">My Bookings</button>-->
                				<!--	<button class="nav-link nav_btn" id="v-pills-messages-tab" data-toggle="pill"-->
                				<!--		data-target="#v-pills-messages" type="button" role="tab"-->
                				<!--		aria-controls="v-pills-messages" aria-selected="false">Extended-->
                				<!--		Warrenty</button>-->
                				<!--	<button class="nav-link nav_btn" id="v-pills-settings-tab" data-toggle="pill"-->
                				<!--		data-target="#v-pills-settings" type="button" role="tab"-->
                				<!--		aria-controls="v-pills-settings" aria-selected="false">Edit Details</button>-->
                				<!--	<a class="nav-link nav_btn" href="<?php echo base_url('logout')?>" type="button"-->
                                                   ...
                                                   <div class="row accnt-row">
                                                    ...
                                                    ?>
                                                       <div class="col-12 col-md-6 col-lg-4"
                                                           style='border-right: 1px solid #efe3e3;'>
                                                           ...
                                                           <div class="row">
                                                               ...
                                                               <div class="col-7 col-sm-12 col-12">
                                                                   <div class='booking_design'>
                                                                       ...
                                                                       <?php echo $book_table['service_device']; ?>, <span> rs. </span>
                                                                       ...
                                                                       <?php
                                                                            ...
                                                                            // if($checklist['request_id']==$req_id){
                                                                            ?>
                                                                       <div class="accnt-order">
                                                                           <h6><a
                                                                                   href="<?= base_url("invoice/$req_id") ?>">Download
                                                                                   Invoice</a></h6>
                                                                       </div>
                                                                       <?php //} ?>
                                           ...
                                           <div class="form-group row">
                                               <div class="col-sm-6 mb-3 mb-sm-0">
                                                   ...
                                                   <input type="text" name="customer_name"
                                                       value="<?php echo $customers[0]['cust_name'];?>"
                                                       id="customer_name" class="form-control form-control-user"
                                                       placeholder="Customer Name">
                                               </div>
                                               <div class="col-sm-6">
                                                   <label for="c_contact">Customer Contact</label>
                                                   <input type="text" name="customer_contact"
                                                       value="<?php echo $customers[0]['contact'];?>"
                                                       id="customer_contact" class="form-control form-control-user"
                                                       placeholder="Contact">
                                               </div>
                                           ...
                                           <div class="form-group row">
                                               <div class="col-sm-6 mb-3 mb-sm-0">
                                                   ...
                                                   <input type="email" name="customer_email"
                                                       value="<?php echo $customers[0]['email_id'];?>"
                                                       id="customer_email" class="form-control form-control-user"
                                           ...
                                           <div class="form-group row">
                                               ...
                                               <div class="col-sm-4">
                                                   ...
                                                   <input type="text" name="customer_address"
                                                       ...
                                                       id="customer_address" class="form-control form-control-user"
                                                       placeholder="Address">
                                               </div>
                                               <div class="col-sm-4">
                                                   <label for="c_pincode">Pincode</label>
                                                   <input type="text" name="customer_pincode"
                                                       value="<?php echo $customers[0]['pincode'];?>"
                                                       id="customer_pincode" class="form-control form-control-user"
                                                       placeholder="Pincode">
                                               </div>
                                           </div>
