					...
					<thead>
						...
						<tr>
							...
							<td>
								...
								<a href="<?php echo base_url('admin/product_features/edit/'.$products['cid']); ?>" type="button" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fas fa-trash" aria-hidden="true"></i></a>
							</td>
						</tr>
						<?php $count++; }
                        ?>
