                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                   ...
                                   foreach($bookings_data as $book){
                                    ...
                                    <td><?php echo $book['cust_name']; ?></td>
                                        ...
                                        <td>
                                          <a href="<?php echo base_url('admin/amc/edit/'.$book['request_id']); ?>"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <a type="button" class="btn btn-secondary" href="<?php echo base_url('admin/amc/delete/'.$book['request_id']); ?>">Delete</a>
