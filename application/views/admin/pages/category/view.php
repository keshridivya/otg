                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                   ...
                                   foreach($categories as $cats){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="<?php echo base_url('admin/category/edit/'.$cats['category_id']); ?>"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <a type="button" class="btn btn-secondary" href="<?php echo base_url('admin/category/delete/'.$cats['category_id']); ?>">Delete</a>
