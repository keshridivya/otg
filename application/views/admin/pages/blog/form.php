                          ...
                          ?>
                            ...
                            <input type="hidden" name='id' value='<?= $blog[0]['id'] ?>'>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleFormControlInput1" value='<?= $blog[0]['name'] ?>'
                                         name='blog'>
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Written By</label>
                                    <input type="text" class="form-control form-control-user" id="exampleFormControlInput1"  value='<?= $blog[0]['writtenby'] ?>'
                                        name="writtenby">
                                </div>
                                <div class="form-group">
                                ...
                                <label for="exampleFormControlInput1">Status</label>
									<select class="form-control" name="cp_status" id="cp_status">
										<option value="active" <?php if( $blog[0]['status']=='active'){ echo 'selected'; } ?>>Active</option>
										<option value="inactive" <?php if( $blog[0]['status']=='inactive'){ echo 'selected'; } ?>>Inactive</option>

									</select>
								</div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Long Description</label>
                                    <textarea id="summernote" name="editordata" class="form-control form-control-user"><?= $blog[0]['description'] ?></textarea>
                                </div>
                                <div class="form-group">
