                        ...
                        <div class="card-body">
                            <div class="section-header text-center">
                                ...
                                <hr>
                                    ...
                                    <form class="new-booking" method="post" action="">
                                 <input type="hidden" class="form-control form-control-user" name="customer_id" value="<?php echo $customers[0]['cust_id'];?>" name="id">
                                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                <div class="form-group row">
                                     <div class="col-sm-4 mb-3 mb-sm-0">
                                        <label for="c_name">Customer Name</label>
                                        <input type="text" name="c_name" value="<?php echo $customers[0]['cust_name'];?>" id="c_name" class="form-control form-control-user"
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" name="quantity" id="quantity" value="<?= $item['qty'] ?>" class="form-control form-control-user" 
                                        placeholder="Total Amount" readonly>
                                    </div>
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        <label for="sub_total">Subtotal</label>
                                    <input type="text" name="sub_total" id="sub_total" value="<?= $item['subtotal'] ?>" class="form-control form-control-user" 
                                        placeholder="Total Amount" readonly>
                                    </div>
                                    <div class="col-sm-4 mb-3 mb-sm-0">
                                        <label for="t_amnt">Total Amount</label>
                                    <input type="text" name="t_amnt" id="t_amnt" value="<?= $this->cart->format_number($this->cart->total()) ?>" class="form-control form-control-user" 
                                        placeholder="Total Amount" readonly>
                                    </div>
                                ...
                                <div class="col-lg-12 text-center">
                                    ...
                                    <input type="submit" name="submit" value="Checkout" class="theme-btn offer-btn">
                                </div>
